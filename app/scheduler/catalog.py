"""Non-blocking periodic catalog refresh scheduler."""
...
class CatalogScheduler:
    """Run catalog refreshes in a worker thread at a fixed interval."""
    ...
    async def start(self) -> None:
        ...
        self._task = asyncio.create_task(self._run(), name="catalog-refresh-scheduler")
    ...
    async def _run(self) -> None:
        if self._refresh_on_startup:
            await asyncio.to_thread(self._service.refresh_all)
